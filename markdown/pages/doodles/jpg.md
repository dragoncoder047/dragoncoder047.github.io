...
There were two raster image projects in the graphic design class I took. I am ashamed to admit these were made in Adobe Photoshop. Unfortunately neither I nor my teacher were allowed to install [GIMP](https://www.gimp.org) on the lab computers due to my college IT department's lengthy software security review process.
...
??? info "Project reflection questions <br><br><small>(from my teacher, and I guess intended to be answered before even starting except I didn't do these until after I was nearly done)</small>"
    > Describe, in a complete sentence, what your project is about. (i.e. what type of persona/creature you wish to make).

    It's an alien (robot?), and I'm not sure how else to describe it. I'm not even quite sure what it is myself. I based it off of [a black-and-white drawing I made a couple of years ago of a similar creature](/blog/2024/i-hope-this-sticks/#the-new-logo).
    ...
    [styropyro's 200 watt laser](https://www.youtube.com/watch?v=UBVlL0FNbSE)
    ...
    It's an alien holding a laser rifle. It's about the closest thing I could find to the thing the character will be actually holding and using in [the game I'm developing them into](/blog/2024/boy-have-i-been/), and I'm never going to find a photo of that thing because it doesn't exist and never will. Need I say more?
...
??? info "Project reflection questions <br><br><small>(once again, I guess intended to be answered before starting, but I don't do that)</small>"
    ...
    This is the player character from [the game I'm developing](/blog/2024/boy-have-i-been/), and they're using one of the in-game items to manipulate the world (i.e. me) outside of the game.

    > List the three images that make up your subject

    1. The sprite of the game character
    2. The game item that they are using
    3. The tiles making up the in-game world
    ...
    2. the human player that is playing the game in the real world (which is a photograph of me!)
    3. the energy bean from the game to the world (not a photo)
